...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(ProjectEMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(ProjectEMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(ProjectEMod.makeImagePath("masks/PowerMask.png"));
