...
import code.ui.AbstractScreenPanel;
...
public class TextSearchBox implements TextReceiver {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(ProjectEMod.makeID("TextSearchBox"));
    public static final String[] TEXT = uiStrings.TEXT;
    public boolean isTyping = false;

    public float waitTimer = 0.0F;
    public String filterTextPlaceholder = TEXT[1];
    ...
    public AbstractScreenPanel receiver;

    public String title = TEXT[0];

    public TextSearchBox(AbstractScreenPanel receiver, float x, float y, boolean digitOnly) {
